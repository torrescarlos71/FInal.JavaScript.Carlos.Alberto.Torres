var calculadora = {
  ...
  //Fin del tamaño de los botones

	//---Fin formato de los botones
	...
	//---Fin de funciónes de la calculadora

	//Funcion de las teclas de la calculadora
	...
	verResultado: function(){ // Tecla Igual
		...
		} else { //Otras veces que presiono igual
		//Calcular el resultado
		this.realizarOperacion(this.primerValor, this.ultimoValor, this.operacion);
		}

		//Almacenar el resultado como primer valor para poder seguir operando
		this.primerValor = this.resultado;

		//Borro el display y lo reemplazo por el resultado
		this.valorVisor = "";

		//verifico el largo del resultado que no sea mayor a 8 digitos para recortarlo si hace falta
		...
		//Auxteclaigual indica si ya se presionó la tecla igual, para calcular sobre el último valor
